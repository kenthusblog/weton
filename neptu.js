        ...
        <div class="card-body">
            ...
            <div class="row mt-3">
                <div class="col-12 hasil" id="hasil" style="background-color: #`+final[2]+`;">
                    <center><b>`+final[1]+`</b></center>
                    <p>
                        &nbsp &nbsp &nbsp `+final[2]+`
                    </p>
                </div>
            </div>
        </div>
