var hasil1 = "<p><b>Sisa 1 (satu) firasatnya Guru</b></p><p>Pada firasat ini memiliki arti bahwa pemilik rumah kelak akan disegani, dihormati, mendapatkan rezeki, rumahnya aman, tentram, kokoh, selamat serta mendapatkan keberkahan.</p>";
var hasil2 = "<p><b>Sisa 2 (dua) firasatnya Ratu</b></p><p>Pada firasat ini memiliki makna bahwa pemilik rumah akan mendapatkan banyak keberuntungan baik itu keberuntungan materil atau imateril, seperti terhindar dari orang orang jahat.</p>";
var hasil3 = "<p><b>Sisa 3 (tiga) firasatnya Rogoh</b></p><p>Pada firasat ini memiliki makna bahwa rumah yang ditempati kelak akan ditimpa musibah seperti kebobolan maling, maka dari itu hindari membangun rumah dimulai pada hari ini.</p>";
var hasil4 = "<p><b>Sisa 4 (empat) firasatnya Sempoyong</b></p>Pada firasat ini memiliki makna bahwa pemilik rumah akan sering ditimpa penyakit dan nasib kurang baik pada pemiliknya serta akan di timpa kesusahan dalam mencari rezeki.</p>";
'use strict';
var HijriJS = {
    currentLanguage: 'en',
            ...
            if (e.tga.value <= max_date[bulan]) {
                ...
                if (i == 0) {
                    ...
                    if (has == 1) {
                        ...
                        var html = "<p>Sisa " + has + " artinya netral, tidak ada makna pada hari ini, anda boleh membangun pada hari ini.</p>"
                    }
                    ...
                    var has = Number(neptu[hrAN][P4Sa]) % 4;
                    if (has == 1) {
                        var html = "<span style='color:green'>Guru</span>"
                    } else if (has == 2) {
                        var html = "<span style='color:green'>Ratu</span>"
                    } else if (has == 3) {
                        var html = "<span style='color:red'>Rogoh</span>"
                    } else if (has == 4) {
                        var html = "<span style='color:red'>Sempoyong</span>"
                    } else {
                        var html = "<span style='color:grey'>Netral</span>"
                    }
