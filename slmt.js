...
function rmlk(e) {
    if ($("#sc").length < 1 || $("#sc").text() !== "Dibuat oleh kenthus") {
    ...
    if (!e.tga.value | !e.tun.value) {
        ...
        for (var i = 0; i < xtb.length; i++) {
            ...
            if (e.tga.value <= max_date[bulan]) {
                ...
                document.getElementById(xtb[i] + 'tggl_lahir_masehi').innerHTML = first_date.getDate() + " " + masehi_month[first_date.getMonth()] + " " + first_date.getFullYear() + " M";
                document.getElementById(xtb[i] + 'tggl_lahir_hijriyah').innerHTML = first_h.day + " " + hijri_month[first_h.month - 1] + " " + first_h.year + " H";
                document.getElementById(xtb[i] + 'tggl_lahir_jawa').innerHTML = first_h.day + " " + java_months[first_h.month - 1] + " " + (Number(first_h.year) + 512) + " Ja";
                document.getElementById(xtb[i] + 'pasaran').innerHTML = hrAN + " " + P4Sa;
                document.getElementById(xtb[i] + 'neptu').innerHTML = Number(neptu[hrAN][P4Sa]);
